...
John Gomez, Kaila Iglesias, Jake Stuck
...
Users: People that use our app can give feedback including suggestions
and/or improvements
...
1.  A progress tracker in the form of a bar

2.  Calorie tracker chart
...
exercising to give you an idea of how much you burned off. We will also
want to add in a system where you can find workouts that are specific to
certain parts of your body or based on your exercise goals. The way we
will implement this is by creating a simple tab with a short list of
exercises that come with an average calorie burn based off of some
number of times you\'ve done it. An example would be 10 push ups is
equal to 100 calories burned.
...
![](media/image1.jpg){width="6.5in" height="7.180555555555555in"}

[6.2. Use Case Descriptions and Interface Sketch]{.ul}
...
just splitting the work.Choose the most important use cases to
describe.*
...
2.  Trainer notifies user of data issue
...
an easy-to-access place so I can manage my weight.
...
As an app user I want to see exercises so that I can choose the best
workout plan for the most calorie burn.

[7.5 User Story 5 - App User - Priority 5, 100 Hours]{.ul}

As an app user I want to use the RPG function so that I can be more
engaged while exercising.
...
certain amount of calories so that I can check if I reached my goals for
the day.
...
watch so I can view my progress more conveniently.
...
upon my level of fitness so that I progress at the speed I want.
...
![](media/image3.png){width="2.307292213473316in"
height="3.8548654855643045in"}![](media/image4.png){width="2.156642607174103in"
height="4.695475721784777in"}![](media/image2.png){width="1.9950054680664917in"
